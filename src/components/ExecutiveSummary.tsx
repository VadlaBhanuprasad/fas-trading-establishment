      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-block mb-3 sm:mb-4">
            <span className="text-emerald-600 font-semibold text-xs sm:text-sm uppercase tracking-wider">Executive Summary</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-16">
          ...
          >
            <p className="text-sm sm:text-lg text-slate-700 leading-relaxed mb-4 sm:mb-6">
            ...
            <p className="text-sm sm:text-lg text-slate-700 leading-relaxed mb-6 sm:mb-8">
            ...
            <div className="space-y-3 sm:space-y-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-start space-x-3 sm:space-x-4 p-3 sm:p-4 bg-slate-50 rounded-lg hover:bg-emerald-50 transition-colors duration-300"
                >
                  <div className="flex-shrink-0">
                    <div className="w-10 sm:w-12 h-10 sm:h-12 bg-emerald-600 rounded-lg flex items-center justify-center">
                      <item.icon className="w-5 sm:w-6 h-5 sm:h-6 text-white" />
                    </div>
                  </div>
                  <div>
                    <h3 className="font-bold text-slate-900 mb-0.5 sm:mb-1 text-sm sm:text-base">{item.title}</h3>
        ...
        <div
          className={`bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl p-6 sm:p-8 md:p-12 shadow-2xl transform transition-all duration-1000 delay-600 ${
