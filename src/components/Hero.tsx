  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-900">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-slate-900/50 via-transparent to-slate-900/80"></div>
        ...
        >
          <div className="inline-block mb-4 px-4 py-2 bg-emerald-600/20 backdrop-blur-sm border border-emerald-400/30 rounded-full">
            <span className="text-emerald-300 text-sm font-medium">Industrial Excellence Since 2010</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <button
              ...
              className="px-8 py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg shadow-xl transform transition-all duration-300 hover:scale-105 hover:shadow-2xl"
            >
              Explore Our Services
            </button>
            <button
              onClick={scrollToContact}
              className="px-8 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-semibold rounded-lg border border-white/30 transition-all duration-300"
            >
              Contact Us Today
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto mt-16">
            {[
              ...
              <div
                key={index}
                className={`bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-6 transform transition-all duration-700 delay-${index * 200} ${
                  isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                }`}
              >
